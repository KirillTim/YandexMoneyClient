...
public class YMCSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_TABLE_OPERATION = "CREATE TABLE IF NOT EXISTS "
            ...
            + OperationColumns.AMOUNTDUE + " TEXT, "
            + OperationColumns.FEE + " TEXT, "
            ...
            + OperationColumns.PAYEEIDENTIFIERTYPE + " INTEGER, "
            + OperationColumns.MESSAGE + " TEXT NOT NULL, "
            + OperationColumns.COMMENT + " TEXT NOT NULL, "
            + OperationColumns.CODEPRO + " INTEGER NOT NULL, "
            + OperationColumns.PROTECTIONCODE + " TEXT, "
            + OperationColumns.EXPIRES + " INTEGER, "
            + OperationColumns.ANSWERDATETIME + " INTEGER, "
            + OperationColumns.LABEL + " TEXT, "
            + OperationColumns.DETAILS + " TEXT, "
