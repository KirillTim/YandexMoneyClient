...
class YMCApplication : Application() {
    ...
    override fun onCreate() {
        ...
        val tokenStr = getSharedPreferences(YMCApplication.PREFERENCES_STORAGE, 0).getString(YMCApplication.PREF_AUTH_TOKEN, "");
//        val tokenStr = "410011641845768."
    ...
    companion object {
        ...
        fun getLogin(): String {
            return appContext?.getSharedPreferences(YMCApplication.PREFERENCES_STORAGE, 0)?.getString(LOGIN, "")?: ""
        }
